...
%imwrite(uint8(imresize(wm1,[256,256])),strcat('2004_results/wm_LL',int2str(i),'.png'));
%imwrite(uint8(imresize(wm2,[256,256])),strcat('2004_results/wm_HL',int2str(i),'.png'));
%imwrite(uint8(imresize(wm3,[256,256])),strcat('2004_results/wm_LH',int2str(i),'.png'));
%imwrite(uint8(imresize(wm4,[256,256])),strcat('2004_results/wm_HH',int2str(i),'.png'));
imwrite(uint8(TT),strcat('2004.png'));
break
end